...
public abstract class Enemy extends Character {
	...
	public void move(double xa, double ya) {
        ...
        if (_board._map[yTemp][xTemp] == 'e') {
            _board._map[yTemp][xTemp] = lastChar;
        }
        ...
        lastChar =_board._map[yTemp][xTemp];
        _board._map[yTemp][xTemp] = 'e';
	}
	...
	public void kill() {
		...
		if (_board._map[getYTile()][getXTile()] == 'e') {
            _board._map[getYTile()][getXTile()] = ' ';
        }
	}
	...
	protected void afterKill() {
		if(_timeAfter > 0) --_timeAfter;
			...
			if(_finalAnimation > 0) --_finalAnimation;
                ...
                remove();
                _board._map[Coordinates.pixelToTile(_y - 13)][Coordinates.pixelToTile(_x)] = ' ';
			}
		}
	}
