...
public class Bomber extends Character {
    ...
    public Bomber(int x, int y, Board board) {
        ...
        _autoPlay = new AutoPlay(_board, this, false);
    ...
    private void detectPlaceBomb() {
        ...
        if(place && Game.getBombRate() > 0 && _timeBetweenPutBombs < 0) {
    ...
    protected void placeBomb(int x, int y) {
        ...
        _board.addBomb(b);
        Sound soundBom = new Sound("set_boom.wav");
        soundBom.play();
    }
    ...
    public void kill() {
        if (!_alive) return;
        _alive = false;
        Sound soundLose = new Sound("die.wav");
        soundLose.play();
    }
